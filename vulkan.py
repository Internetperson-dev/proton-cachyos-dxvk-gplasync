...
class VulkanVersion:
    ...
    @classmethod
    def from_version(cls, major: int, minor: int, patch: int):
    ...
    @classmethod
    def _try_convert_to_cls(cls, thing):
...
class VulkanPhysicalDeviceProperties:
    ...
    @classmethod
    def from_native_obj(cls, properties: VkPhysicalDeviceProperties):
        return cls(
...
class VulkanPhysicalDeviceIDProperties:
    ...
    @classmethod
    def from_native_obj(cls, properties: VkPhysicalDeviceIDProperties):
        return cls(
...
class VulkanExtensionProperties:
    ...
    @classmethod
    def from_native_obj(cls, properties: VkExtensionProperties):
        return cls(
...
class VulkanInstance:
    ...
    def enumerate_physical_devices(self, num = None) -> Generator[VulkanPhysicalDevice]:
