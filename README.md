...
| `dxvkgplasync`       | `PROTON_DXVK_GPLASYNC`         | Use the [dxvk-gplasync](https://gitlab.com/Ph42oN/dxvk-gplasync) fork as DXVK replacement for those who might want it. Async is enabled by default, so it **SHOULD NOT** to be used with games using anti-cheat or multiplayer games in general. You have been warned.                                                                                                                                                                |
