...
| `dxvksarek`          | `PROTON_DXVK_SAREK`            | Use the [dxvk-sarek](https://github.com/pythonlover02/DXVK-Sarek) as DXVK replacement for older GPUs that don't properly support Vulkan 1.3. It is using the `async` branch, so it **SHOULD NOT** to be used with games using anti-cheat or multiplayer games in general. You have been warned.                                                                                                                                       |
| `dxvkgplasync`       | `PROTON_DXVK_GPLASYNC`         | Use the [dxvk-gplasync](https://gitlab.com/Ph42oN/dxvk-gplasync) as DXVK replacement for those who might want it. Async is enabled by default, so it **SHOULD NOT** to be used with games using anti-cheat or multiplayer games in general. You have been warned.                                                                                                                                       |
...
| `nvidialibsno32`     | `PROTON_NVIDIA_LIBS_NO_32BIT`  | Use with the previous option, to enable only the 64bit nvidia libraries. Useful if you are using RTX series 4000 or 5000 GPUs and you might bad performance or crashes when enabling these with 32bit games.                                                                                                                                                                                                                          |
...
| `mediaconv`          | `PROTON_ENABLE_MEDIACONV`      |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|                      | `PROTON_MEDIA_USE_GST`         |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|                      | `PROTON_GST_VIDEO_ORIENTATION` |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `nowmdecoration`     | `PROTON_NO_WM_DECORATION`      |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `wayland`            | `PROTON_ENABLE_WAYLAND`        | Enable Wayland support. For other related options refer to [Proton-EM documentation](https://github.com/Etaash-mathamsetty/Proton/blob/em-10/docs/EM-ADDITIONS.md)                                                                                                                                                                                                                                                                    |
| `hdr`                | `PROTON_ENABLE_HDR`            |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `sdlinput`           | `PROTON_PREFER_SDL`            |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|                      | `PROTON_NO_STEAMINPUT`         |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `localshadercache`   | `PROTON_LOCAL_SHADER_CACHE`    | Enable per-game shader cache even if "Shader Pre-caching" is disabled. Any configuration set by this option is options, i.e. if one of the environment variables is already set, the user-set value will be used. By default, the configuration is set up to mimic Steam's "Shader Pre-Caching", with shaders being cached under `<steamlibrary>/shadercache/<appid>` for each game.                                                  |
